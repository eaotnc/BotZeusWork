...
{
	$msg = urlencode("".$translate["NO_STUDENT_INFORMATION_WAS_FOUND_FOR_RECORDING_THE_SPECIFIED_GRADE"]."...");
...
/*
mysql_connect(HOST, USERNAME, PASSWORD) or die( mysql_error() );// die ("".$translate["CANNOT_CONNECT_TO_THE_SERVER"]."");
...
function validateFactor()
{
	...
	if(percent!=100)
	{
		alert("ค่าเปอร์เซนต์รวมทั้งหมด ("+percent+"%) ต้องเท่ากับ 100% เท่้านั้น \n\nอย่างน้อยที่สุดควรจะมีการประเมินผลในแบบ Final Exam\nในลำดับสุดท้าย");
		return false;
	}
	return true;
}
...
<table cellspacing="0" cellpadding="0" width="750" border="0">
  ...
  <TR>
    <TD height=21 align="center" background="../images/label_m21.jpg"><strong><?=$translate["SCORING_SYSTEM_AND_CUTTING_GRADE"]?></strong></TD>
  </TR>
	<tr>
		<td height="1" align="center"></td>
	</tr>
	<tr>
		<td height="18" align="center" bgcolor="#E1E1E1"><strong><?=$translate["REGULAR_TER"]?>&nbsp;<?=$semester?>&nbsp;&nbsp;&nbsp;<?=$translate["YEAR"]?>&nbsp;<?=$year?></strong></td>
	</tr>
	<tr>
  ...
  <TR>
    <TD height=21 align="center" background="../images/horline_c750o.jpg"><a href="#" onClick="return go2Criteria()">".$translate["SET_THE_SCORE_CRITERIA"]."</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;".$translate["SET_THE_SCORE_RANGE"]."&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="#" onClick="return go2Score()">".$translate["SCORE_RECOR"]."</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="#" onClick="return go2Show()">".$translate["CHECK_THE_SCORE"]."</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="#" onClick="return go2Table()"><?=$translate["SCATTER_TABLE"]?></a></TD>
  </TR>
	<tr>
		<td height="1"></td>
	</tr>
	...
	<tr>
		<td bgcolor="#ECECEC"><table width="750" border="1" cellpadding="0" cellspacing="0">
			<tr>
				...
				คุณกำหนด".$translate["GRADE_CUTTING_STYLE"]."ของกลุ่มนี้โดยเลือกที่จะไม่ใช้ระบบตัด".$translate["GRADE"]."ช่วยประมวลผล...ดังนั้นจึงไม่ต้องป้อนข้อมูลการ<?=$translate["SET_THE_SCORE_RANGE"]?> 
				</td>
			</tr>
		</table></td>
	</tr>
...
?>	
  ...
  <tr>
		<td><table width="750" border=0 align="center" cellpadding=0 cellspacing=0>
			<tr>
				<td width="70" height="21" align="center" bgcolor="#E1E1E1"><strong>ลำดับที่</strong></td>
				<td width="1" ></td>
				<td width="*" align="center" bgcolor="#E1E1E1"><strong>การประเมินผล</strong></td>
				<td width="1" ></td>
				<td width="100" align="center" bgcolor="#E1E1E1"><strong>คะแนนเต็ม</strong></td>
				<td width="1" ></td>
				<td width="100" align="center" bgcolor="#E1E1E1"><strong>คิดเป็นเปอร์เซนต์</strong></td>
				<td width="1" ></td>
				<td width="120" align="center" bgcolor="#E1E1E1"><strong>ประเภท</strong></td>
				<td width="1" ></td>
				<td width="100" align="center" bgcolor="#E1E1E1"><strong>ประกาศผล</strong></td>
				<td width="1" ></td>
				<td width="120" align="center" bgcolor="#E1E1E1"><strong>ใชช่วงคะแนนนี้</strong></td>
			</tr>
			<tr>
				<td height="1"></td>
			</tr>
...
<input type="hidden" name="s" id="s" value="<?=$s?>">
			<tr title="การปรเิมินผลของช่วงคะแนนนี้จะถูกนำไปแสดงในคอลัมน์ที่ 1 ของช่องคะแนนในตาราง".$translate["SCORE_RECOR"]."">
          ...
          <option value="3" <?= ($f1_exm==3)?"selected":NULL?>>Other...</option>
				...
				<td></td>
				<td align="center" bgcolor="#ECECEC">
				<input type="checkbox" name="f1_pos" id="f1_pos" value="1" <?=!$f1_pos?NULL:"checked"?> <?=!$f1_del?"disabled":NULL?>>ประกาศ
				</td>
				<td></td>
				<td align="center" bgcolor="#ECECEC">
				<!--input type="checkbox" name="f1_del" value="<?=$f1_del?>" size="3" maxlength="3"-->
				<input name="f1_del" type="radio" id="f1_del" value="1" <?=$f1_del==1?"checked":NULL?> onClick="enableInput('1')">ใช้&nbsp;
				<input name="f1_del" type="radio" id="f1_del" value="0" <?=!$f1_del?"checked":NULL?> onClick="disableInput('1')">ไม่ใช้ &nbsp;
				</td>
			</tr>
			<tr>
				<td height="1"></td>
			</tr>
			<tr title="การปรเิมินผลของช่วงคะแนนนี้จะถูกนำไปแสดงในคอลัมน์ที่ 2 ของช่องคะแนนในตาราง".$translate["SCORE_RECOR"]."">
          ...
          <option value="3" <?= ($f2_exm==3)?"selected":NULL?>>Other...</option>
				...
				<input type="checkbox" name="f2_pos" id="f2_pos" value="1" <?=!$f2_pos?NULL:"checked"?> <?=!$f2_del?"disabled":NULL?>>ประกาศ
				</td>
				<td></td>
				<td align="center" bgcolor="#FDF3E7">
				<input name="f2_del" type="radio" id="f2_del" value="1" <?=$f2_del==1?"checked":NULL?> onClick="enableInput('2')">ใช้&nbsp;
				<input name="f2_del" type="radio" id="f2_del" value="0" <?=!$f2_del?"checked":NULL?> onClick="disableInput('2')">ไม่ใช้ &nbsp;
				</td>
			</tr>
			<tr>
				<td height="1"></td>
			</tr>
			<tr title="การปรเิมินผลของช่วงคะแนนนี้จะถูกนำไปแสดงในคอลัมน์ที่ 3 ของช่องคะแนนในตาราง".$translate["SCORE_RECOR"]."">
          ...
          <option value="3" <?= ($f3_exm==3)?"selected":NULL?>>Other...</option-->
				...
				<td></td>
				<td align="center" bgcolor="#ECECEC">
				<input type="checkbox" name="f3_pos" id="f3_pos" value="1" <?=!$f3_pos?NULL:"checked"?> <?=!$f3_del?"disabled":NULL?>>ประกาศ
				</td>
				<td></td>
				<td align="center" bgcolor="#ECECEC">
				<input name="f3_del" type="radio" id="f3_del" value="1" <?=$f3_del==1?"checked":NULL?> onClick="enableInput('3')">ใช้&nbsp;
				<input name="f3_del" type="radio" id="f3_del" value="0" <?=!$f3_del?"checked":NULL?> onClick="disableInput('3')">ไม่ใช้ &nbsp;
				</td>
			</tr>
			<tr>
				<td height="1"></td>
			</tr>
			<tr title="การปรเิมินผลของช่วงคะแนนนี้จะถูกนำไปแสดงในคอลัมน์ที่ 4 ของช่องคะแนนในตาราง".$translate["SCORE_RECOR"]."">
          ...
          <option value="3" <?= ($f4_exm==3)?"selected":NULL?>>Other...</option-->
				...
				<td></td>
				<td align="center" bgcolor="#FDF3E7">
				<input type="checkbox" name="f4_pos" id="f4_pos" value="1" <?=!$f4_pos?NULL:"checked"?> <?=!$f4_del?"disabled":NULL?>>ประกาศ
				</td>
				<td></td>
				<td align="center" bgcolor="#FDF3E7">
				<input name="f4_del" type="radio" id="f4_del" value="1" <?=$f4_del==1?"checked":NULL?> onClick="enableInput('4')">ใช้&nbsp;
				<input name="f4_del" type="radio" id="f4_del" value="0" <?=!$f4_del?"checked":NULL?> onClick="disableInput('4')">ไม่ใช้ &nbsp;
				</td>
			</tr>
			<tr>
				<td height="1"></td>
...
?>
	...
	<tr>
		...
		<input type="button" value="  ".$translate["RECORD"]."   " title="".$translate["RECORDING_CRITERIA_FOR_CUTTING_GRADE_COURSES"]." <?=$subject_id?>" onClick="return go2SaveFactor()"></td>
	</tr>
<?
}
?>	
