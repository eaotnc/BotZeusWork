...
//mysql_connect(HOST, USERNAME, PASSWORD) or die( mysql_error() );// die ("");
//mysql_select_db(DB_NAME) or die( mysql_error() );// die( "");
...
function validateScore()
{
	...
	if(gradetype==0)
	{
		...
		if(a <0||a >100||a <=bp){alert(" \n\n A  B+  100"); return false;}
		if(bp<0||bp>100||bp<= b){alert(" \n\n B+  B   A"); return false;}
		if(b <0||b >100||b <=cp){alert(" \n\n B  C+   B+"); return false;}
		if(cp<0||cp>100||cp<= c){alert(" \n\n C+  C   B"); return false;}
		if(c <0||c >100||c <=dp){alert(" \n\n C  D+   C+"); return false;}
		if(dp<0||dp>100||dp<= d){alert(" \n\n D+  D   C"); return false;}
		if(d <0||d >100||d >=dp){alert(" \n\n D  F   D+"); return false;}
	}
	else
	if(gradetype==1)//
	{
		...
		if(!grade_max||!grade_min){alert(" \n T-Score"); return false;}
		var gx=0;
		switch(grade_max)
		{
			case 'A': gx=7; break;
...
<table cellspacing="0" cellpadding="0" width="750" border="0">
  ...
  <TR>
    <TD align="center" vAlign=middle><a href="../index.php"><img src="images/u_teacher2.jpg" alt="" width="750" height="40" border="0"></a></TD>
  </TR>
  <TR>
    <TD height="10" align="left"></TD>
  </TR>
  <TR>
    <TD height=21 align="center" background="../images/label_m21.jpg"><strong></strong></TD>
  </TR>
	<tr>
		<td height="1" align="center"></td>
	</tr>
	<tr>
		<td height="18" align="center" bgcolor="#E1E1E1"><strong>&nbsp;<?=$semester?>&nbsp;&nbsp;&nbsp;&nbsp;<?=$year?></strong></td>
	</tr>
	<tr>
  ...
  <TR>
    <TD height=21 align="center" background="../images/horline_c750o.jpg">&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="#" onClick="return go2Factor()"></a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="#" onClick="return go2Score()"></a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="#" onClick="return go2Show()"></a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="#" onClick="return go2Table()"></a></TD>
  </TR>
	<tr>
		<td height="1"></td>
	</tr>
	...
	<tr>
		<td bgcolor="#f8f8f8"><table width="750" border="1" cellpadding="0" cellspacing="0">
			<tr>
				<td height="32" align="left" bgcolor="#F0F0F0">&nbsp;<strong> :</strong>
				<input name="gradetype" type="radio" id="gradetype" value="0" <?=!$gradetype?"checked":"onClick='return go2Criteria()'"?>>
<? if($system_cut){?>
				&nbsp;&nbsp;&nbsp;
				<input name="gradetype" type="radio" id="gradetype" value="1" <?=$gradetype==1?"checked":"onClick='return go2Criteria()'"?>> T-Score
				&nbsp;&nbsp;&nbsp;
				<input name="gradetype" type="radio" id="gradetype" disabled value="2" <?=$gradetype==2?"checked":"onClick='return go2Criteria()'"?>> Mean-SD		
<? }?>				
				&nbsp;&nbsp;&nbsp;
				<input name="gradetype" type="radio" id="gradetype" value="3" <?=$gradetype==3?"checked":"onClick='return go2Criteria()'"?>> (S, U)
				</td>
			</tr>
		</table></td>
	</tr>
...
?>	
  ...
  <tr>
		<td><table width="750" border=0 align="center" cellpadding=0 cellspacing=0>
			<tr>
				<td width="80" height="21" align="center" bgcolor="#E1E1E1"><strong></strong></td>
				<td width="1" ></td>
				<td width="100" align="center" bgcolor="#E1E1E1"><strong></strong></td>
				<td width="1" ></td>
				<td width="100" align="center" bgcolor="#E1E1E1"><strong></strong></td>
				<td width="1" ></td>
				<td width="*" align="center" bgcolor="#E1E1E1"><strong></strong></td>
				<td width="1" ></td>
				<td width="100" align="center" bgcolor="#E1E1E1"><strong></strong></td>
			</tr>
			<tr>
...
if($gradetype<3)
{
	...
	if($gradetype==1||$gradetype==2)
	{
		...
		switch($grade_max)
		{
			case 'A': $gx=7; $ac	= ""; break;
			case 'B+':$gx=6; $bpc	= ""; break;
			case 'B': $gx=5; $bc	= ""; break;
			case 'C+':$gx=4; $cpc	= ""; break;
			case 'C': $gx=3; $cc	= ""; break;
			case 'D+':$gx=2; $dpc	= ""; break;
			case 'D': $gx=1; $dc	= ""; break;
			case 'F':	$gx=0; $fc	= ""; break;
		}
		switch($grade_min)
		{
			case 'A': $gn=7; $af = ""; break;
			case 'B+':$gn=6; $bpf= ""; break;
			case 'B': $gn=5; $bf = ""; break;
			case 'C+':$gn=4; $cpf= ""; break;
			case 'C': $gn=3; $cf = ""; break;
			case 'D+':$gn=2; $dpf= ""; break;
			case 'D':	$gn=1; $df = ""; break;
			case 'F':	$gn=0; $ff = ""; break;
		}
	}
?>			
...
?>			
	...
	<tr>
		...
		<input type="button" value="     " title=" <?=$subject_id?>" onClick="return go2SaveCriteria()"></td>
	</tr>
	<tr>
		<td height="1"></td>
	</tr>
